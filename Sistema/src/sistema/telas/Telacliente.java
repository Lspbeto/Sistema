...
public class Telacliente extends JInternalFrame {
    ...
    private JTextField tfIdcli, tfNomecli, tfFonecli;
    private JButton btnInclu, btnAlter, btnExclu, btnConsul;
 ...
 // Método para adicionar um cliente
    private void adicionarUsuario() {
        ...
        String sql = "INSERT INTO tbcliente (nomecli, fonecli) VALUES (?, ?)";
        try {
        ...
        } catch (SQLException e) {  // Exemplo: captura de uma exceção SQL
        ...
        private void alterarUsuario() {
            ...
            String sql = "UPDATE tbcliente SET nomecli=?,  fonecli=? WHERE idcli=?";
            try {
                pst = conexao.prepareStatement(sql);
                pst.setString(1, nome);
                pst.setString(2, telefone);
        ...
        private void pesquisarUsuario() {
            ...
            try {
                ...
                rs = pst.executeQuery();
                if (rs.next()) {
                    jTextField2.setText(rs.getString("nomecli"));
                  
                    jTextField4.setText(rs.getString("fonecli")); // Corrigido para "telefone"
                } else {
